...
// Code from https://github.com/microsoft/DirectX-Graphics-Samples
// Used for random number generator that can use STL or provide a faster implementation.

// Comment this out to test using C++ STL implementation of random number generators.
// #define USE_STL
